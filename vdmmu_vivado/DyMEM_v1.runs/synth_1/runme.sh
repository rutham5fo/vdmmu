...
HD_PWD='C:/VivadoProjects/Thesis/DyMEM_v2_optimized_tb/DyMEM_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmem_manager.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmem_manager.tcl
